...
MATRICULA: 372565
FECHA: Nov - 28 - 2023
DESCRIPCION: LIBRERIA CON VALIDACIONES, CADENAS, ETC.
NOMBRE DEL ARCHIVO: lavanda.h
*/
...
void puesto_empleado(char cadena[]);
...
/* PARA FUNCIONES */
void preguntar(char mensaje[], char cadena[])
{
    printf("%s", mensaje);
    fflush(stdin);
    gets(cadena);
...
int telefono_random(char telefono_random[])
{
    int tel1, tel2;

    tel1 = rango(100, 999);
    tel2 = rango(1000, 9999);

    sprintf(telefono_random, "%d%d%d%d", tel1 / 100, tel1 % 100, tel2 / 100, tel2 % 100);
}
...
void puesto_empleado(char cadena[])
{
    char Puestos[10][20] = {"CAJERO", "VENDEDOR", "REPONEDOR", "GERENTE", "SUPERVISOR", "AUXILIAR", "ENCARGADO", "ASISTENTE", "PROMOTOR", "PASILLERO"};
    strcpy(cadena, Puestos[rand() % 10]);
}

void nombre_femenino1(char cadena[])
{
    char PriNomFem[30][10] = {"ANA", "MARIA", "DANNA", "ELBA", "IRMA", "SONIA", "LUZ", "DULCE", "EVA", "CARMEN",
                              "LAURA", "ISABEL", "ROSARIO", "FABIOLA", "ANGELA", "ROCIO", "RAQUEL", "LUISA", "MONICA", "OLGA",
                              "PATRICIA", "SARA", "ANAIS", "VERONICA", "KARINA", "LOURDES", "NATALIA", "VANESSA", "ALICIA", "ELISA"};
    strcpy(cadena, PriNomFem[rand() % 30]);
}

void nombre_femenino2(char cadena[])
{
    char SegNomFem[30][15] = {"VICTORIA", "FERNANDA", "CRISTINA", "CAROLINA", "ALEJANDRA", "ISABELA", "DANIELA", "MARTINA", "SOFIA", "MARIANA",
                              "CLAUDIA", "BEATRIZ", "JULIA", "DANIELA", "GLORIA", "CARMEN", "ANAHI", "ESTEFANIA", "EMILIA", "CONSUELO",
                              "FATIMA", "VALERIA", "VERONICA", "ELENA", "DIANA", "ARACELI", "LILIANA", "CELINA", "LORENA", "ANA LUISA"};
    strcpy(cadena, SegNomFem[rand() % 30]);
}

void nombre_masculino1(char cadena[])
{
    char PriNomMas[30][10] = {"LUIS", "HECTOR", "SAUL", "SAID", "IVAN", "JESUS", "ALDO", "PABLO", "KEVIN", "OMAR",
                              "ANTONIO", "JUAN", "CARLOS", "JOSE", "MIGUEL", "ALBERTO", "FELIPE", "JAVIER", "ADRIAN", "EDUARDO",
                              "RICARDO", "FRANCISCO", "GABRIEL", "DIEGO", "RAMON", "OSCAR", "FERNANDO", "MANUEL", "SERGIO", "ALEJANDRO"};
    strcpy(cadena, PriNomMas[rand() % 30]);
}

void nombre_masculino2(char cadena[])
{
    char SegNomMas[30][10] = {"FERNANDO", "ALEJANDRO", "RAFAEL", "ANTONIO", "FRANCISCO", "ALFREDO", "JAZIEL", "MANUEL", "MIGUEL", "JAVIER",
                              "JORGE", "GUSTAVO", "CARLOS", "ALVARO", "JULIO", "ENRIQUE", "ARMANDO", "ROBERTO", "HUMBERTO", "RICARDO",
                              "LEONARDO", "GERARDO", "FELIX", "PABLO", "ISMAEL", "SANTIAGO", "EZEQUIEL", "EDUARDO", "LUCAS", "FABIAN"};
    strcpy(cadena, SegNomMas[rand() % 30]);
}

void apellidos(char cadena[])
{
    char Apellido1[30][15] = {"LOPEZ", "GOMEZ", "DIAZ", "OROZCO", "AGUILAR", "CAMPOS", "JIMENEZ", "VAZQUEZ", "LOMA", "PEREZ",
                              "ANDRADE", "PALACIOS", "GONZALEZ", "HERNANDEZ", "RODRIGUEZ", "MARTINEZ", "CHAVEZ", "CRUZ", "SANCHEZ", "QUIJADA",
                              "RAMIREZ", "TORRES", "FLORES", "VILLANUEVA", "DELGADO", "CASTILLO", "SERRANO", "TORO", "MENDOZA", "CASAS"};
    strcpy(cadena, Apellido1[rand() % 30]);
}
...
void estados(char cadena[])
{
    char EstadosMexicanos[32][3] = {
        "AG", "BC", "BS", "CM", "CS", "CH", "CO", "CL",
        "DG", "GT", "GR", "HG", "JC", "MC", "MN", "MS",
        "NT", "NL", "OC", "PL", "QT", "QR", "SP", "SL",
        "SR", "TC", "TS", "TL", "VZ", "YN", "ZS", "ZT"};
    strcpy(cadena, EstadosMexicanos[rand() % 32]);
}
